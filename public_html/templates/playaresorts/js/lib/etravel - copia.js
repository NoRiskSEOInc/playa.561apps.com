(function ($) {
 $(document).ready(function() {
   ...
   if ( $("#formahotel").length === 1 ) DefVar("#formahotel"); else DefVar("#formapackage");
	...
	$(".etWrow img").click(function(){ $("#helphm").show();});
	$("#helpcont #Closehm").click(function(){ $("#helphm").hide();});
	 ...
	 //jQuery(".extran").hide();
 	 ...
 	 jQuery("#EtHt").change(function(){
		if(parseInt(jQuery(this).val())==1209){ jQuery("#formahotel .extran, .extran span").hide(); }
		if(parseInt(jQuery(this).val())==5){ jQuery("#formahotel .extran").show(); }
		if(parseInt(jQuery(this).val())==487){ jQuery("#formahotel .extran, .extran span").hide(); }
		if(parseInt(jQuery(this).val())==230){ jQuery("#formahotel .extran").show(); }
		if(parseInt(jQuery(this).val())==3871){ jQuery("#formahotel .extran, .extran span").hide(); }
		if(parseInt(jQuery(this).val())==10241853){ jQuery("#formahotel .extran").show(); }			
	});	

 	 jQuery("#EtHId").change(function(){
		if(parseInt(jQuery(this).val())==1209){jQuery("#EtDestinyPkl").val("Hyatt Zilara Cancún"); jQuery("#EtIATds").val("CUN"); jQuery("#EtdtPk").val(2); jQuery("#formapackage .extran, .extran span").hide(); }
		if(parseInt(jQuery(this).val())==5){jQuery("#EtDestinyPkl").val("Gran Caribe Real Cancún"); jQuery("#EtIATds").val("CUN"); jQuery("#EtdtPk").val(2); jQuery("#formapackage .extran").show(); }
		if(parseInt(jQuery(this).val())==487){jQuery("#EtDestinyPkl").val("THE Royal Playa del Carmen"); jQuery("#EtIATds").val("CUN"); jQuery("#EtdtPk").val(16); jQuery("#formapackage .extran, .extran span").hide(); }
		if(parseInt(jQuery(this).val())==230){jQuery("#EtDestinyPkl").val("Gran Porto Real Playa del Carmen"); jQuery("#EtIATds").val("CUN"); jQuery("#EtdtPk").val(16); jQuery("#formapackage .extran").show(); }
		if(parseInt(jQuery(this).val())==3871){jQuery("#EtDestinyPkl").val("Hyatt Zilara Rose Hall"); jQuery("#EtIATds").val("MBJ"); jQuery("#EtdtPk").val(130); jQuery("#formapackage .extran, .extran span").hide(); }
		if(parseInt(jQuery(this).val())==10241853){jQuery("#EtDestinyPkl").val("Hyatt Ziva Rose Hall"); jQuery("#EtIATds").val("MBJ"); jQuery("#EtdtPk").val(130); jQuery("#formapackage .extran").show(); }			
	});

 	 jQuery(".etWSelect select").change(function(){
		if(parseInt(jQuery(this).val())==0){ jQuery(".extran span").hide(); }
		if(parseInt(jQuery(this).val())==1){ jQuery(".extran span").show(); }
		if(parseInt(jQuery(this).val())==2){ jQuery(".extran span").show(); }
		if(parseInt(jQuery(this).val())==3){ jQuery(".extran span").show(); }			
	}); 	
 ...
 function ResetAll() {
     ...
     $("#EtCityOrig, #EtCityOrigFL, #EtDestinyFL").val(MsjAirport);
     ...
     //Formulario
     $("input[name='do'],input[name='pu'],input[name=ctf]").val('');
 }
 //Modificar el foco
